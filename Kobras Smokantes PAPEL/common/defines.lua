...
country = {
	...
	BASE_COUNTRY_TAX_EFFICIENCY = 0.000001, -- Basic efficiency for taxes without 'crats and tech
	...
	NONCORE_TAX_PENALTY = -0.15, -- -5% for each non-core in state
	BASE_TARIFF_EFFICIENCY = 0.000001, -- baseline tariff efficiency
...
diplomacy = {
	...
	GIVEMILACCESS_RELATION_ON_ACCEPT = 30,
	...
	INCREASERELATION_RELATION_ON_ACCEPT = 40,
	INCREASERELATION_RELATION_ON_DECLINE = 0,
	INCREASERELATION_DIPLOMATIC_COST = 2,

	DECREASERELATION_RELATION_ON_ACCEPT = -40,
